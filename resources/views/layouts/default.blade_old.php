...
<div class="container-fluid">
  <div class="row-fluid"> 
    ...
    <!-- start: Main Menu -->
    <div id="sidebar-left" class="span1"> @if(UserType::getUserTypeByID(Auth::user()->type_id)=='customer')
      @include('common.sidebar_customer')
      @elseif(UserType::getUserTypeByID(Auth::user()->type_id)=='vendors')
  ...
  @include('common.widgets') <a id="widgets-area-button" class="hidden-tablet hidden-phone open"><i class="fa-icon-reorder"></i></a> </div>
<!--/fluid-row-->

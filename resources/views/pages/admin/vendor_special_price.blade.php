    ...
    <div class="row-fluid">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon th-list"></i><span class="break"></span>List Vendor Special Price</h2>
                ...
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                        ...
                        <?php
                         ...
                         $customerfirstname="";
            if(isset($special_price->user->first_name))
            {
             $customerfirstname=$special_price->user->first_name;
            }

             $customerlastname="";
            if(isset($special_price->user->last_name))
            {
             $customerlastname=$special_price->user->last_name;
            }

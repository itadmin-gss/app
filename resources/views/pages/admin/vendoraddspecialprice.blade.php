            ...
            <div class="box-content custome-form">
                ...
                <form class="form-horizontal">
                    <fieldset> 
                        ...
                        <div class="control-group">
                            {!! Form::label('adminAddSpecialPriceCustomerDropdown', 'Vendor: ', array('class' => 'control-label')) !!}
                            <div class="controls">
                       ...
                       <div class="control-group">
                        ...
                        <div class="form-actions">
                            ...
                            {!! Form::button('Cancel', array('class'=>'btn btn-large btn-info text-right','id'=>'','onClick' =>'location.href="'.URL::to('vendor-list-special-prices').'"'))!!}
                        </div>                               
                    </fieldset>
                </form>
            </div>

...
<div class="modal-body" style="min-height:400px !important;">
  <div class="row-fluid">
    ...
    {!! Form::open(array('url' => 'assign-service-bid','id'=>'assignRequest')) !!}

    <div id="errorMessage" style="display: none;"> </div>
    <div  style="width:100%;float:left;"><h3 style="width:50%;float:left;">Bid Services</h3>
      <h3 style="width:50%;float:left;">Available Vendors</h3></div>
      {!! Form::hidden('request_id', $request_maintenance->id);!!}
         {!! Form::hidden('flagworkorder', $flagworkorder);!!}
...
@if($flagworkorder=="")
<div>
  Remind me on:<input type="text" name="remindme" id="remindme" class="datepicker">
 </div>
 @endif
{!! Form::close() !!}
</div>

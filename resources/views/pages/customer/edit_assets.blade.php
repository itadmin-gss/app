 ...
 <?php
                            ...
                            <div class="control-group dmState">
                               ...
                               <?php
                                ...
                                $cities = \App\City::getCitiesByStateId($asset_data['state_id']);
                    ...
                    <div class="control-group thirdStep accrodSlid">
                        ...
                        <div class="controls">
                            <label class="radio">
                               {!! Form::radio('electric_status',  '1', isset($asset_data['electric_status']) && $asset_data['electric_status']==1  ? true : '',  array('id'=>'electric_status'))!!}                                    Yes                                    Yes
                            </label>

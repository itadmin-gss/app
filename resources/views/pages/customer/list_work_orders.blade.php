...
<!--                <div class="box-icon">
            ...
            <div class="box-content">
                ...
                <table class="tbstyl table table-striped table-bordered bootstrap-datatable datatable">
...
<!--                    <label> Select Date Range </label>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="center dmWdt"><a class="btn btn-success" title="View Order" disabled="disabled" href="#"> <i class="halflings-icon zoom-in halflings-icon"></i> </a> <!-- <a class="btn btn-info" disabled="disabled" href="#"> <i class="halflings-icon edit halflings-icon"></i> </a> --></td>

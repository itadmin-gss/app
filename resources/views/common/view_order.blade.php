...
@if($message == "")
   ...
   <h4 class="alert alert-success">
     ...
     <p></p>
          @endif
 <!-- <a class="btn pinkBgcolor btn-info " href="{{URL::to('add-osr-request')}}"  style="float: right;position: relative;z-index: 999;float:left;"> OSR  </a>
 -->
...
$totalPrice+=$vendor_priceFIND;
                ...
                //    print_r($order->maintenanceRequest->asset->customer_id);
            ...
            if (isset($order->customer->id)) {
                       ...
                       $SpecialPriceCustomer=  SpecialPrice::where('service_id','=',$order_detail->requestedService->service->id)
                             ...
                             ->where('customer_id','=',$order->maintenanceRequest->asset->customer_id)
...
$totalPrice+=$vendor_priceFIND;
            ...
            <?php
                 ...
                 $vendor_priceFIND=$order_detail->requestedService->service->customer_price*$order_detail->requestedService->quantity;

                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            {!! Form::text('username',  isset($user_data['username']) ? $user_data['username'] : '' , array('class'=>'form-control','id'=>'username'))!!}
                            ...
                            <div class="row-fluid custome-input">
                                ...
                                <div class="control-group span3">
                                    ...
                                    <div class="form-inline">
                                        ...
                                        {!! Form::select('city_id', $city_data , isset($user_data['city_id']) ? $user_data['city_id'] : '0' , array('style'=>'width:200px;' ,'class'=>'form-control','id'=>'city_id', 'data-rel'=>'chosen'))!!}
                            ...
                            <div id="changePasswordControll" class="box hide">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="form-inline">
                                        ...
                                        {!! Form::password('current_password', array('class'=>'form-control','id'=>'password'))!!}
     ...
     {!! $servicesDATAoption!!}
                      ...
                      @if(Auth::user()->type_id==3)
                        <div class="clearfix"></div>
                               <div class="form-inline control-group" style="margin-left:0px;">
                            ...
                            <div class="form-actions text-left" style="margin-top:20px !important;">

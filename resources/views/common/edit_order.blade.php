...
?>
    ...
    <h5>Property Address:  </h5> <span >{!!$order->maintenanceRequest->asset->property_address!!}</span> <br>
    <div id="printdata1">
    </div>
...
if(Auth::user()->type_id==1 || Auth::user()->type_id==4)
{
    ...
    Vendor: <select name="vendorsAssigned" class='chosen' >
    <?php
...
<div class="row-fluid">
    <div class="box span12">
        <table class="table table-bordered customeTable">
            <tbody>
                <tr>
                    <td class="center span3"><h5><span>Property #:</span>{!!$order->maintenanceRequest->asset->asset_number!!}</h5></td>
        ...
        <div class="box span12" id="comehere">
            <div class="box-header" data-original-title>
                ...
                <?php if(Auth::user()->type_id==1 || Auth::user()->type_id==4){ ?>
                  <button data-toggle="modal" data-target="#edit_request_service" data-backdrop="static" ><i class="halflings-icon edit" ></i> Edit Service</button>
                <?php }elseif($order_detail->requestedService->service->vendor_edit == 1){ ?>
                  <button data-toggle="modal" data-target="#edit_request_service" data-backdrop="static" ><i class="halflings-icon edit" ></i> Edit Service</button>
                <?php } else{ ?><i class="halflings-icon edit" ></i> <?php } ?><span class="break"></span>{!!$order_detail->requestedService->service->title!!}</h5>
                <div class="box-icon">
                    <?php
                 ...
                 <?php }else {
                   ...
                   if(!empty($SpecialPriceCustomer[0]))
                   {
                    if (!empty($custom->customer_price)) {
                      $totalPriceCustomer+=$custom->customer_price * $custom->quantity;?>
                      Customer Price:${!!$custom->customer_price * $custom->quantity!!}
                      <?php }else{
...
<?php }else{  ?>
 ...
 <?php }
  ...
  if(!empty($SpecialPriceCustomer[0]))
  { ?>
<?php if (!empty($custom->customer_price)&&!empty($custom->quantity)){ ?>

<?php $totalPriceCustomer+=$custom->customer_price*$custom->quantity;?>
...
<div class="box-content">
    ...
    <table class="table">
        ...
        if( Auth::user()->type_id == 1 || Auth::user()->type_id == 4) {
            ...
            <td colspan="2" class="center"><h5>Customer Note:</h5>{!!$custom->customers_notes!!}   </td>
            @else
            <td colspan="2" class="center"><h5>Customer Note:</h5>{!!$order_detail->requestedService->customer_note!!}   </td>
            @endif
        </tr>
        <tr>
           @if(isset($custom->notes_for_vendors))
           <td colspan="2" class="center"><h5>Note for Vendor:</h5>{!!$custom->notes_for_vendors!!}</td>

           @else
           <td colspan="2" class="center"><h5>Note for Vendor:</h5>{!!$order_detail->requestedService->public_notes!!}

           </td>  @endif
       </tr>
       <tr>
        @if(isset($custom->vendors_notes))
        <td colspan="2" class="center"><h5>Vendor Note:</h5>{!!$custom->vendors_notes!!}</td>
        @else
        <td colspan="2" class="center"><h5>Vendor Note:</h5>{!!$order_detail->requestedService->vendor_note!!}
        </td>  @endif
    </tr>
     ...
     <tr>
        <td colspan="2" class="center"><h5>Note for Vendor:</h5>
             ...
             <tr>
                <td class="center" colspan="2">
                  <span class="pull-left">
                   ...
                   <a href="#"  onclick="popModalExport({!!$order->id!!}, {!!$order_detail->id!!}, 'before')" > <button @if(Auth::user()->type_id==3 && $order->status==4) disabled="disabled"@endif  data-toggle="modal" data-backdrop="static" data-target="#export_view_images" class="btn btn-large btn-warning pull-right myBtnImg" style=" margin: 0 15px 0 0; border-radius: 2px; font-size: 18px;"> Export Images
                   </button></a>
               </span>

               <span class="pull-left">
                <button  @if(Auth::user()->type_id==3 && $order->status==4) disabled="disabled"@endif data-toggle="modal" data-backdrop="static" data-target="#before_{!!$order_detail->id!!}" class="myBtnImg btn btn-large btn-success">Upload Before Images</button>
            ...
            <span class="pull-during">
                <button  @if(Auth::user()->type_id==3 && $order->status==4) disabled="disabled"@endif data-toggle="modal" data-backdrop="static" data-target="#during_{!!$order_detail->id!!}" class="myBtnImg btn btn-large btn-success">Upload During Images</button>
            ...
            <span class="pull-right">
                <button  @if(Auth::user()->type_id==3 && $order->status==4) disabled="disabled"@endif  data-toggle="modal" data-backdrop="static" data-target="#after_{!!$order_detail->id!!}" class="myBtnImg btn btn-large btn-success">Upload After Images</button>
                                    ...
                                    <tr>
                                        <td colspan="2" class="center"><h5>Customers Note:</h5>
                                            ...
                                            <!-- Edit Service request pop modal Starts
                                              ...
                                              2 = customers
                                              3 = vendors -->
                                            <div style="padding: 10px;max-height: 500px;overflow: auto;" role="dialog" class="modal hide fade modelForm"  id="edit_request_service">
...
if ( $custom->customer_price != 0){ ?>
                                           ...
                                           <div class="row-fluid">
                                            <div class="box span12">
                                               ...
                                               //$totalPriceCustomerFinal += $totalPriceCustomer;
                                                ...
                                                <?php $totalPriceCustomerFinal += $item->customer_price * $item->quantity; ?>
                                                @else
                                                ...
                                                <div class="box-header" data-original-title="">
                                                    ...
                                                    <div class="box-icon">
                                                      <?php if (Auth::user()->type_id==1 || Auth::user()->type_id==2){ ?>
                                                        ...
                                                        Customer Price:${!!$item->customer_price * $item->quantity!!}
 ...
 -->
                                    ...
                                    <div style="padding: 10px;max-height: 500px;overflow: auto;" class="modal hide fade modelForm"  id="before_{!!$item->id!!}">
...
<div style="padding: 10px;max-height: 500px;overflow: auto;" role="dialog" class="modal hide fade modelForm"  id="before_view_image_{!!$item->id!!}">
...
<div style="padding: 10px;max-height: 500px;overflow: auto;" class="modal hide fade modelForm"  id="during_{!!$item->id!!}">
    <div class="row-fluid dragImage">
...
<div style="padding: 10px;max-height: 500px;overflow: auto;" role="dialog" class="modal hide fade modelForm"  id="during_view_image_{!!$item->id!!}">
...
<div style="padding: 10px;max-height: 500px;overflow: auto;" class="modal hide fade modelForm"  id="after_{!!$item->id!!}">
    <div class="row-fluid dragImage">
...
<div style="padding: 10px;max-height: 500px;overflow: auto;" class="modal hide fade modelForm"  id="after_view_image_{!!$item->id!!}">
...
<div style="padding: 10px;max-height: 500px;overflow: auto;" role="dialog" class="modal hide fade modelForm"  id="export_additional_view_images_{!!$item->id!!}">
...
<div style="padding: 10px;max-height: 500px;overflow: auto;" role="dialog" class="modal hide fade modelForm"  id="edit_additional_item_{!!$item->id!!}">
...
<div class="popUpInnr clearfix">
	<a href="javascript:;" class="myClose btn btn-danger">X</a>
<div class="span"  id="getpopup">
</div>
<div class="popModal clearfix">
<div class="span clearfix" id="additionalServiceRequeste">
...
<!--/   Modal-Section Show Export Images Start   -->
<div style="padding: 10px;max-height: 500px;" role="dialog" class="modal hide fade modelForm"  id="export_view_images">
    <div class="well text-center"><h1>Export Image</h1></div>

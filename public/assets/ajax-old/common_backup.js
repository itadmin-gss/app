...
function auto_load(){
    ...
    $('.mystatusclass li > a').click(function(e){
        ...
        $.ajax({
           ...
           if(after<=0)
           {
               alert("Please at leaset one after images");
               $('#overlay').remove();
               return false;
           }
           ...
           if(during<=0)
           {
               alert("Please at leaset one during images");
               $('#overlay').remove();
               return false;
           }
...
// function ShowAdditionalServiceForm(){
    ...
    function SubmitAdditionalItem() {
     ...
     var vendor_id = $("#vendor_id").val();  
       if (title.length == 0 || rate.length == 0) {
     ...
     $.ajax({
            ...
            data:{title:title,rate:rate,description:description,quantity,quantity,vendor_id:vendor_id,order_id:order_id},
            success: function(data) {
                 location.reload();
                $('#overlay').remove();
 ...
 function updateAdditionalitem(id){
       ...
       $.ajax({
            ...
            data:{description:description,quantity:quantity,rate:rate},
            success: function(data) {
                console.log(data);
                  location.reload();
                $('#overlay').remove();

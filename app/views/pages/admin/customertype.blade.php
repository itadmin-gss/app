    ...
    <div class="row-fluid">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><span class="break"></span>Add Customer Type</h2>
            </div>
            ...
            <div class="box-content custome-form">
                ...
                @endforeach
                @endif
                {{ Form::open(array('url' => 'addCustomerType', 'class' => 'form-horizontal', 'method' => 'post')) }}
                <fieldset>
                    ...
                    <div class="form-actions">
                        ...
                        <div class="pull-right">
            				 {{ Form::submit('Add Customer Type', array('class' => 'btn btn-large btn-success')) }}
                            {{ Form::button('Cancel', 

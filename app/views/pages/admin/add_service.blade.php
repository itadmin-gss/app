      ...
      <div class="box-content custome-form"> 
        ...
        ?>
              ...
              <div class="control-group"> {{ Form::label('customer_price', 'Customer Price: *', array('class' => 'control-label')) }}
                <div class="controls">
                  <div class="input-append"> {{ Form::text('customer_price', '', array('class' => 'input-xlarge focused',
                    'id' => 'focusedInput')) }} </div>
                </div>
              </div>
              <div class="control-group"> {{ Form::label('vendor_price', 'Vendor Price: *', array('class' => 'control-label')) }}
                <div class="controls">
                  <div class="input-append"> {{ Form::text('vendor_price', '', array('class' => 'input-xlarge focused',
                    'id' => 'focusedInput')) }} </div>
                </div>
              </div>
              <div class="control-group"> {{ Form::label('desc', 'Description: ', array('class' => 'control-label')) }}
                <div class="controls">
                  <div class="input-append"> {{ Form::textarea('desc', '', array('class' => 'input-xlarge focused',
                    'id' => 'focusedInput')) }} </div>
                </div>
              </div>
              <div class="control-group"> {{ Form::label('desc', 'Due Date: ', array('class' => 'control-label')) }}
                 <div class="controls">
                   <div class="input-append"> {{Form::text('due_date_val', '', array('class'=> 'input-xlarge focused datepicker', 'id'=> 'due_date_val' ))}} </div>
                 </div>
              </div>
              ...
              <div class="control-group"> {{ Form::label('req_date', 'Services Required Date:', array('class' => 'control-label')) }}
                <div class="controls">
              ...
              <div class="control-group"> {{ Form::label('pool_service_type', 'Pool Service Type:', array('class' => 'control-label')) }}
                <div class="controls">
                 ...
                 <div class="control-group"> {{ Form::label('boarding_type', 'Boarding Service Type:', array('class' => 'control-label')) }}
                <div class="controls">
              ...
              <div class="control-group"> {{ Form::label('remove_carpe_type', 'Remove Carpet Type:', array('class' => 'control-label')) }}
                <div class="controls">
              ...
              <div class="control-group"> {{ Form::label('remove_blinds_type', 'Remove Blinds Type:', array('class' => 'control-label')) }}
                <div class="controls">
              ...
              <div class="control-group"> {{ Form::label('remove_appliances_type', 'Remove Appliances Type:', array('class' => 'control-label')) }}
                <div class="controls">

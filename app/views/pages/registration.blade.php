...
@section('content')
<div id="content" class="span12 registerd">

    <div class="row-fluid registerd">
                    ...
                    <div class="row-fluid">
                        <div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    {{ Form::text('username', '', array('class'=>'span10 typeahead','id'=>'username', 'data-rel'=>'tooltip', 'data-original-title'=>'Tooltip, you can change the position'))}}
                                </div>
                            </div>
